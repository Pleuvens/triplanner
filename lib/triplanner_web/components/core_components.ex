defmodule TriplannerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TriplannerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TriplannerWeb.Gettext, "errors", msg, opts)
    end
  end
